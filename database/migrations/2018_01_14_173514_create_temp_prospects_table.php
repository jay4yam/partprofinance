...
class CreateTempProspectsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('temp_prospects', function (Blueprint $table) {
            ...
            $table->string('pays_de_naissance')->nullable();
            $table->string('dpt_de_naissance')->nullable();
            ...
            $table->string('secteur_activite_conjoint')->nullable();
            ...
            $table->double('valeur_de_votre_bien_immobilier')->nullable();
            $table->double('mensualite_immo')->nullable();
            $table->double('pension_alimentaire')->nullable();
            ...
            $table->date('banque_depuis')->nullable();
