...
<head>
    <meta charset="utf-8">
    <title>{{ $title }} | PartProFinance CRM</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <!-- Meta No-index, No follow -->
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url()->route('home') }}" class="logo">
            ...
            <span class="logo-lg"><b>PartPro</b>Finance</span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <!-- search form -->
            <form action="/prospect" method="get" class="sidebar-form">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{ url()->route('prospect.index') }}">
                                <i class="fa fa-th-list" aria-hidden="true"></i> Liste des prospects
                            </a>
                        </li>
                        <li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="#">JayBen</a>.</strong> Tous droits réservés
    </footer>
