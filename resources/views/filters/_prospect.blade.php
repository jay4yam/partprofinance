<div class="box">
    ...
    @endif
    <div class="form-group sep">
        {{ Form::select('annee', $prospectYears, Request::get('annee') ? Request::get('annee') : '', ['class' => 'form-control', 'placeholder' => 'choisissez l\'annee']) }}
    </div>
    <div class="form-group sep">
        {{ Form::select('mois', $prospectMonths, Request::get('mois') ? Request::get('mois') : '', ['class' => 'form-control', 'placeholder' => 'choisissez le mois']) }}
    </div>
    <div class="form-group sep">
